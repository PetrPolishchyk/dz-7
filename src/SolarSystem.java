public enum SolarSystem {
    ...
    private final Double distanceFromThePreviousPlanet;
    private final Double distanceToTheSun;
    private final Double radius;
    private final SolarSystem previousPlanet;

    SolarSystem(Integer orderFromSun, Double distanceFromThePreviousPlanet, Double radius, SolarSystem previousPlanet) {
